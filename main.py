...
def main():
    ...
    # for emp in employee_db.calisanları_gosterme():
    #     print(emp)
    ...
    inventory_db.update_inventory_bulk({'qty':{'$lt':50}},{'size.uom':'inch','status':'P'})#miktarı 50'den az olanın size uom ismini inch yapın ve statusunu P ile değiştirin
